 ...
 *         This is the class for Multiple Choice question type, user is
 *         presented 4 options and selects
 *         one of the options.
 */
public class MultipleChoice implements Question {
     ...
     * Constructor
     * 
     * @param options ArrayList<String> of the options, should be a list of 4
     *                options, convert Phrases to String before passing
    ...
    // interface is String, class is int. Maybe make returntype generic for
    // interface?
    ...
    /**
     * 
     * @return the boolean value of if the question was answered correctly or not,
     *         default false.
     */
    @Override
    ...
    /**
     * Grabs the input and compares to the answer, if equal, then sets correct to
     * true.
     * 
     * @param input the String value input to be compared to the answer NOTE: can be
     *              A B C D
     */
    @Override
